  ...
  return (
    <nav className="bg-white p-4 flex justify-between items-center shadow-sm">
      ...
      <div className="flex items-center gap-4">
        ...
        <Link href="/usertypes/store" className="text-black font-bold text-lg">
          Emporio Cives
        </Link>
      </div>
      ...
      <ul className={`md:flex gap-4 items-center ${isOpen ? 'flex flex-col absolute top-16 inset-x-0 p-4 bg-white shadow-md' : 'hidden'}`}>
        <li>
          <Link href="/usertypes/store" className="text-gray-600 hover:text-black transition-colors">
            Home
          </Link>
        </li>

        <li>
          <Link href="/usertypes/store/browse" className="text-gray-600 hover:text-black transition-colors">
            Buscar
          </Link>
        </li>
