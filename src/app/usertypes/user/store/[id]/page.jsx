// Página con informacion del comercio para los usuarios registrados
...
function StoreShowcasePage({ params }) {
        ...
        <>
            <main className="bg-gray-100">
                <div className="container mx-auto px-4">
                    ...
                    <a href={`/usertypes/user/store/${params.id}/add-review`}>
                        Añadir reseña
                    </a>
...
export default StoreShowcasePage;
